...
python -m tf2onnx.convert --input SOURCE_FROZEN_GRAPH_PB\
    ...
    [--opset OPSET]
    [--optimize_transpose Enable_Transpose_Optimization]
```
...
- optimize_transpose: when set to True, those transposes operations introduced during tf-graph-to-onnx-graph conversion will be removed.
