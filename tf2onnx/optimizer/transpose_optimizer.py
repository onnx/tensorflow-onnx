        ...
        for op in nodes:
            if op.type == "Transpose":
                ...
                if len(input_shape) == 4 and \
                        (is_nchw_transpose(op) and (input_shape[3] == 1 or (input_shape[1:3] == [1, 1]))) or \
                        (is_nhwc_transpose(op) and (input_shape[1] == 1 or (input_shape[2:4] == [1, 1]))):
