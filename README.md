...
- optimize_transpose: when set True, those transpose operations introduced during tfgraph-to-onnxgraph conversion will be removed.
...
optional arguments:
  ...
  --optimize_transpose when set True, those transpose operations introduced during tf-graph-to-onnx-graph conversion will be removed.
```
