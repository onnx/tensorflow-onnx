...
def slice_birnn_for_original_rnn_consumers(g, rnn_fw, rnn_bw, bi_rnn, rnn_output_index, all_nodes, to_remove):
    ...
    if rnn_output_index == 0:
        ...
        for r_op in reverse_nodes:
            ...
            g.replace_all_inputs(all_nodes, r_op.output[0], r_op.input[0], keep_ops=False)
    ...
    if fw_consumers:
        ...
        g.replace_all_inputs(fw_consumers, rnn_fw.output[rnn_output_index], slice_node_fw, keep_ops=False)
    ...
    if bw_consumers:
        ...
        g.replace_all_inputs(bw_consumers, rnn_bw.output[rnn_output_index], slice_node_bw, keep_ops=False)
...
def remove_reverse_in_bw_input(g, bw_rnn_input_x, rnn_type):
    ...
    if not old_x_has_rnn_as_consumer:
        ...
        g.replace_all_inputs(g.get_nodes(), reverse_node.output[0], reverse_node.input[0], keep_ops=False)
