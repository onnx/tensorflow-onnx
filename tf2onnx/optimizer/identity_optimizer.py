...
class IdentityOptimizer(GraphOptimizerBase):
    ...
    def _handle_non_graph_output_identity(graph, identity):
        ...
        graph.replace_all_inputs(graph.get_nodes(), old_name, new_name, add_identity=False)
    ...
    def _handle_graph_output_identity(self, graph, identity, graph_outputs):
        ...
        graph.replace_all_inputs(graph.get_nodes(), input_id, output_id, add_identity=False)
        return True
